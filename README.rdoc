...
Production Considerations
  Config variables stored on Heroku instead of Github to keep secret keys secret. Unicorn utilized for background jobs to maintain site speed. All sensetive data, like passwords and credit card information, handled in secure manners.
